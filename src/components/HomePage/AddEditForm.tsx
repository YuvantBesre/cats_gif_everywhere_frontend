...
const AddEditForm = (props : AddEditFormProps) => {
    ...
    return (
        <form className="text-black p-8 flex flex-col gap-y-8" onSubmit={handleOnSubmit}>
            ...
            <div>
                <button className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 flex items-center justify-start">
                    Submit
                    {
                        props.loader &&
                        <svg aria-hidden="true" className="w-4 h-4 ml-2 text-gray-200 animate-spin dark:gray fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
